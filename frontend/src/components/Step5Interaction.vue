...
const renderMarkdown = (content) => {
  ...
  // Clean up whitespace after list open tags
  html = html.replace(/<ul class="md-ul">\s+/g, '<ul class="md-ul">')
  html = html.replace(/<ol class="md-ol">\s+/g, '<ol class="md-ol">')
  // Clean up whitespace before list close tags
  ...
  // Clean up <br> tags that immediately follow block-level elements before paragraph open tags
...
/* Quote styles in chat / survey areas */
