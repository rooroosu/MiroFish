...
const statusText = computed(() => {
  ...
  if (currentPhase.value === 0) return 'Ontology generation in progress'
  return 'Initializing'
})
  ...
  try {
    ...
    if (projectResponse.success && projectResponse.data.graph_id) {
      ...
      if (graphResponse.success && graphResponse.data) {
        ...
        // Update rendering when data has changed
...
const renderGraph = () => {
  ...
  // Draw edges (including wide transparent clickable lines)
  ...
  // Wide transparent line for clicking
  ...
  simulation.on('tick', () => {
    // Update positions of all edges (visible line + transparent click area)
