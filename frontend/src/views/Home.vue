    ...
    <div class="main-content">
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <!-- Project simulation step introduction (new section) -->
...
// Start simulation — redirect immediately; API call happens on Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Redirect immediately to Process page (special marker indicates new project)
    router.push({
      name: 'Process',
