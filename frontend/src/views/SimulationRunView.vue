...
// Read maxRounds from query params at init time so child components get the value immediately
...
const handleGoBack = async () => {
  ...
  try {
    // Attempt graceful close of simulation environment first
...
const loadGraph = async (graphId) => {
  // During active simulation, auto-refresh skips full-screen loading to avoid flicker
