...
returning the full list transparently to callers.
"""
...
def fetch_all_nodes(
    ...
    """Fetch all graph nodes with pagination, returning at most max_items (default 2000). Each page request has built-in retry."""
    all_nodes: list[Any] = []
