...
Manages parallel simulation on Twitter and Reddit platforms
Uses preset scripts + LLM-intelligent config generation
"""
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Args:
            ...
            document_text: raw document content (for LLM background understanding)
        ...
        try:
            ...
            # Reddit was already saved in real-time during generation; save once more to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            # Note: run scripts remain in backend/scripts/ and are no longer copied to the simulation dir
            # When starting a simulation, simulation_runner runs the script from scripts/
