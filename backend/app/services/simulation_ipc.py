...
2. Simulation script polls the command directory, executes commands, writes responses to responses/
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: platform to target (optional)
                ...
                - "reddit": Reddit only
                - None: both platforms in dual-platform simulation; the single platform otherwise
            timeout: timeout in seconds

        Returns:
            IPCResponse; result field contains the interview result
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: default platform (optional; overridden per interview item)
                ...
                - None: both platforms per agent in dual-platform simulation
            timeout: timeout in seconds
