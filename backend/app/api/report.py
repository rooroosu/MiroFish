"""
Report API routes
Endpoints for generating, retrieving, and chatting with simulation reports
"""
...
def chat_with_report_agent():
    ...
    Request (JSON):
        {
            "simulation_id": "sim_xxxx",        // required
            "message": "Explain the public sentiment trend",  // required
...
def get_agent_log(report_id: str):
    ...
    Retrieve every step of the report generation process in real time, including:
